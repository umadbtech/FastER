...
interface ProfileApiService {
     ...
     * Save user's legal first and last name
     */
    @POST("functions/v1/save-profile-name")
     ...
     * Get signed avatar URL for current user
     */
    @GET("functions/v1/avatar-url")
...
data class SaveLegalNameRequest(
    @kotlinx.serialization.SerialName("legal_first_name")
    val legalFirstName: String,
    @kotlinx.serialization.SerialName("legal_last_name")
...
data class UploadAvatarResponse(
    ...
    val ok: Boolean,
    @kotlinx.serialization.SerialName("signed_url")
    val signedUrl: String? = null,
    @kotlinx.serialization.SerialName("avatar_path")
...
data class AvatarUrlResponse(
    ...
    @kotlinx.serialization.SerialName("signed_url")
    val signedUrl: String? = null,
    @kotlinx.serialization.SerialName("expires_in_seconds")
    val expiresInSeconds: Int? = null
)

@kotlinx.serialization.Serializable
data class SaveEmergencyContactRequest(
    @kotlinx.serialization.SerialName("external_name")
    val name: String,
    @kotlinx.serialization.SerialName("external_phone_e164")
    val phone: String,
    @kotlinx.serialization.SerialName("relationship")
    val relationship: String? = null,
    @kotlinx.serialization.SerialName("is_primary")
    val isPrimary: Boolean = false,
    @kotlinx.serialization.SerialName("contact_id")
    val contactId: String? = null  // For updates
)
